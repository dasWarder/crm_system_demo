...
public interface TaskRepository
    extends PagingAndSortingRepository<Task, Long>, JpaSpecificationExecutor<Task> {
  ...
  Page<Task> getTasksByStartFromAfterAndDeadlineBefore(
      LocalDateTime startTime, LocalDateTime deadline, Pageable pageable);
}
