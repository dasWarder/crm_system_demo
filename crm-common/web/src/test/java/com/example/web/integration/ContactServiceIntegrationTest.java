...
import static com.example.web.data.TestData.*;
...
@Sql(
    scripts = {
      ...
      "classpath:/db/contactManager/populate_contact.sql"
    })
public class ContactServiceIntegrationTest extends AbstractTest {
  ...
  public void shouldFindAllContactsProperly() {
    ...
    List<Contact> expectedContacts =
        Stream.of(TEST_CONTACT_1, TEST_CONTACT_2, TEST_CONTACT_3, TEST_CONTACT_4, TEST_CONTACT_5)
    ...
    assertThat(actualContactsPage.getContent())
  ...
  public void shouldFindAllByFilterParamProperly() {
    ...
    List<Contact> sortedByFullName =
        Stream.of(TEST_CONTACT_3, TEST_CONTACT_4).collect(Collectors.toList());
  ...
  public void shouldSaveContactProperly() {
    ...
    assertThat(store).usingRecursiveComparison().isEqualTo(storedContact);
  }

  @Test
  public void shouldUpdateContactByEmailProperly()
      throws ContactNotFoundException, UserNotFoundException {

    log.info("Test updateContactByEmail() method of the Contact service class");

    Contact updatedContact =
        contactService.updateContactByEmail(TEST_CONTACT_3.getEmail(), TEST_UPDATE_CONTACT);

    Assertions.assertNotNull(updatedContact);
    assertThat(updatedContact).usingRecursiveComparison().isEqualTo(TEST_UPDATE_CONTACT);
  }
  ...
  public void shouldGetContactByIdProperly() throws ContactNotFoundException {
    ...
    assertThat(getContactById).usingRecursiveComparison().isEqualTo(TEST_CONTACT_1);
  }
  ...
  public void shouldThrowExceptionIfGetContactByIdWithWrongId() {
    ...
    Assertions.assertThrows(
        ContactNotFoundException.class, () -> contactService.getContactById(WRONG_ID));
  }
  ...
  public void shouldGetContactByEmailProperly() throws ContactNotFoundException {
    ...
    assertThat(contactByEmail).usingRecursiveComparison().isEqualTo(TEST_CONTACT_1);
  }
  ...
  public void shouldThrowExceptionIfGetContactByEmailWithWrongEmail() {
    ...
    Assertions.assertThrows(
        ContactNotFoundException.class, () -> contactService.getContactByEmail(WRONG_EMAIL));
  }
